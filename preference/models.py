...
class Preference(models.Model):
    ...
    time_per_week = models.IntegerField(validators=[MinValueValidator(5), MaxValueValidator(6000)])
    time_per_session = models.IntegerField(validators=[MinValueValidator(5), MaxValueValidator(600)])
